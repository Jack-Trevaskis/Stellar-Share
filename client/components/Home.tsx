  ...
  return (
    <>
      ...
      <p className="text-lg text-end mb-6">
        ...
        from across the stars! Whether you’re looking for cutting-edge tech,
        ...
        At Stellar Share, we’re not just about trade—we are about building a
        connected galaxy, one exchange at a time. Use, trade, rent, and
        explore—all with the freedom to shape your journey, your way. Would you
        like to add any specific services or enhance the branding?
      </p>
      <div className="flex flex-col items-center space-y-4">
