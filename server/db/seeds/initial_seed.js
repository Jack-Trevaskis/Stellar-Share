  ...
  await knex('stuff').insert([
    {
      ...
      owner_id: 1,
      price: 10,
      image_url: '/images/stuff/lightsaber2.jpg',
      bond: 10,
      condition: 'great',
    },
    {
      ...
      owner_id: 1,
      price: 20,
      image_url: '/images/stuff/Luke_gunner_01.webp',
      bond: 20,
      condition: 'great',
    },
    {
      ...
      owner_id: 2,
      price: 50,
      image_url: '/images/stuff/StrangeChangeTimeMachine.jpg',
      bond: 40,
      condition: 'mint',
    },
    {
      ...
      owner_id: 3,
      price: 20,
      image_url: '/images/stuff/Bag-of-Holding-140-Polyhedral-Dice-in-20.webp',
      bond: 15,
      condition: 'used',
    },
  ])
